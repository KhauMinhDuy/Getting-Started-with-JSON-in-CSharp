...
namespace m2
{
    public class JsonDatesDemo
    {
        public static void Show()
        {
            ...
            string dateMicrosoftOldDefault = JsonConvert.SerializeObject(dates, Formatting.Indented, settingsMicrosoftDate);
            ...
            string dateJavaScript = JsonConvert.SerializeObject(dates, Formatting.Indented, new JavaScriptDateTimeConverter());
            ...
            string dateUnixDateTimeConverter = JsonConvert.SerializeObject(dates, Formatting.Indented, new UnixDateTimeConverter());
